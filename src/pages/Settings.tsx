...
const Settings = () => {
  const [n8nUrl, setN8nUrl] = useState(import.meta.env.VITE_N8N_API_URL || 'http://localhost:5678');
  const [n8nToken, setN8nToken] = useState(import.meta.env.VITE_N8N_API_TOKEN || '');
  const [evolutionUrl, setEvolutionUrl] = useState(import.meta.env.VITE_EVOLUTION_API_URL || 'http://localhost:8080');
